...
static constexpr uint8_t GROVEPWR = 22;
static constexpr uint8_t GROVEPWR_OFF = LOW;
static constexpr uint8_t GROVEPWR_ON = HIGH;

static constexpr uint8_t BEEDTR = 23;
static constexpr uint8_t BEERTS = 20;
static constexpr uint8_t BEECTS = 19;

static constexpr uint8_t LED2 = 8;                  // Green
static constexpr uint8_t LED1 = 9;                  // Red

static constexpr uint8_t BATVOLTPIN = 30;           // A6
