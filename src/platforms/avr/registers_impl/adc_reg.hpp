...
#ifdef ADMUX
FASTHAL_DECLARE_REGISTER_ONLY(admux, ADMUX)
#endif
#ifdef ADCSRA
FASTHAL_DECLARE_REGISTER_ONLY(adcsra, ADCSRA)
#endif
#ifdef ADCSRB
FASTHAL_DECLARE_REGISTER_ONLY(adcsrb, ADCSRB)
#endif
#ifdef ADC
FASTHAL_DECLARE_REGISTER_ONLY(adc, ADC)
#endif
#ifdef ADCH
FASTHAL_DECLARE_REGISTER_ONLY(adch, ADCH)
#endif
#ifdef ADCL
FASTHAL_DECLARE_REGISTER_ONLY(adcl, ADCL)
#endif
