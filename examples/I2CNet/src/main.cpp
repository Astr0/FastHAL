...
// 3 - net args sync -  static args, static buffer (612/9 - 1 current_op, (2 buffer + 1 count + 1 status + 2 callback) = 6 args, 2 current va)
...
#if (MODE == 3)
auto i2c0_h = i2c_sync<i2c<0>, args_base_t>{};
#define SYNC
#else
